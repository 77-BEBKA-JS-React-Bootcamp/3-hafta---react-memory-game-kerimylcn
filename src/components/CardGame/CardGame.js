...
import crab from './../../assets/dog.png';
import dolphin from './../../assets/pitbull.png';
import fish from './../../assets/fish.png';
import kraken from './../../assets/cow.png';
import octopus from './../../assets/octopus.png';
import shrimp from './../../assets/bee.png';
import turtle from './../../assets/turtle.png';
import whale from './../../assets/pig.png';
...
class CardGame extends Component{
    constructor(props){
        ...
        this.state ={
            cards: [
                {name: 'dog', open: false, id: 1, image : crab , isCompleted: false},
                {name: 'pitbull', open: false, id: 2, image : dolphin , isCompleted: false},
                {name: 'fish', open: false, id: 3, image : fish , isCompleted: false},
                {name: 'cow', open: false, id: 4, image : kraken , isCompleted: false},
                ...
                {name: 'pig', open: false, id: 8, image : whale , isCompleted: false},
